    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="px-3 py-2 border border-slate-200 rounded-lg text-sm w-72 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
      ...
      <div className="relative mb-4">
        ...
        <input
          ...
          placeholder="Search skills in the control library..."
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex border border-slate-200 rounded-lg overflow-hidden ml-2">
            <button
              ...
              className={`p-1.5 ${viewMode === 'grid' ? 'bg-primary-600 text-white' : 'text-slate-500 hover:bg-slate-50'}`}
            >
              <LayoutGrid className="w-4 h-4" />
            </button>
            <button
              onClick={() => setViewMode('list')}
              className={`p-1.5 ${viewMode === 'list' ? 'bg-primary-600 text-white' : 'text-slate-500 hover:bg-slate-50'}`}
            >
      ...
      {filtered.length === 0 ? (
        <div className="text-center py-12 text-slate-500">
          ...
          <p className="text-sm mt-1">Install a skill using the input above</p>
        </div>
      ) : (
