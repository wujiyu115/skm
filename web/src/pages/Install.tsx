...
const registry: RegistrySkill[] = [
  // Anthropic official
  { name: 'algorithmic-art', description: 'Algorithmic art with p5.js and seeded randomness', source: 'anthropics/skills', repo: 'anthropics/skills/algorithmic-art', category: 'official', icon: '🎨' },
  { name: 'brand-guidelines', description: 'Anthropic brand colors and typography', source: 'anthropics/skills', repo: 'anthropics/skills/brand-guidelines', category: 'official', icon: '🏷️' },
  { name: 'canvas-design', description: 'Visual art in PNG and PDF using design philosophy', source: 'anthropics/skills', repo: 'anthropics/skills/canvas-design', category: 'official', icon: '🖼️' },
  { name: 'claude-api', description: 'Claude API reference and SDK usage', source: 'anthropics/skills', repo: 'anthropics/skills/claude-api', category: 'official', icon: '🤖' },
  { name: 'doc-coauthoring', description: 'Structured documentation co-authoring workflow', source: 'anthropics/skills', repo: 'anthropics/skills/doc-coauthoring', category: 'official', icon: '✍️' },
  { name: 'docx', description: 'Word document generation and manipulation', source: 'anthropics/skills', repo: 'anthropics/skills/docx', category: 'official', icon: '📝' },
  ...
  { name: 'internal-comms', description: 'Internal communications writing', source: 'anthropics/skills', repo: 'anthropics/skills/internal-comms', category: 'official', icon: '📨' },
  { name: 'mcp-builder', description: 'Build MCP servers for LLM tool integration', source: 'anthropics/skills', repo: 'anthropics/skills/mcp-builder', category: 'official', icon: '🔌' },
  { name: 'pdf', description: 'PDF document generation and manipulation', source: 'anthropics/skills', repo: 'anthropics/skills/pdf', category: 'official', icon: '📄' },
  ...
  { name: 'slack-gif-creator', description: 'Animated GIFs optimized for Slack', source: 'anthropics/skills', repo: 'anthropics/skills/slack-gif-creator', category: 'official', icon: '🎞️' },
  { name: 'theme-factory', description: 'Theme and design system generation', source: 'anthropics/skills', repo: 'anthropics/skills/theme-factory', category: 'official', icon: '🎨' },
  { name: 'web-artifacts-builder', description: 'Build web artifacts and components', source: 'anthropics/skills', repo: 'anthropics/skills/web-artifacts-builder', category: 'official', icon: '🌐' },
  ...
  { name: 'xlsx', description: 'Excel spreadsheet generation and manipulation', source: 'anthropics/skills', repo: 'anthropics/skills/xlsx', category: 'official', icon: '📈' },
  // Vercel
